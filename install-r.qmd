...
One way to access R and RStudio is via an account at <https://r.stem.calvin.edu/> (or if not a Calvin student, at [posit.cloud](https://posit.cloud)). To use RStudio on one of these servers, all you need to do is log in, with nothing to install or maintain.
